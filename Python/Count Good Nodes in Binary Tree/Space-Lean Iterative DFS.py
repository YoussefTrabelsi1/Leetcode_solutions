...
# Complexity: O(n) time, O(h) space (stack).
...
def count_good_nodes_iterative_dfs(root):
...
print(count_good_nodes_iterative_dfs(root1))  # expected 3
print(count_good_nodes_iterative_dfs(root2))  # expected 4
